...
import cn.code.chameleon.spider.scheduler.component.RedisBloomFilterRemover;
import cn.code.chameleon.spider.scheduler.component.RedisDuplicateRemover;
...
public enum DuplicateRemoverEnum {
    ...
    REDIS_SET(3, "Redis哈希去重", new RedisDuplicateRemover("localhost")),
    REDIS_BLOOM_FILTER(4, "Redis布隆过滤器去重", new RedisBloomFilterRemover("localhost"));
